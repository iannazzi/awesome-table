module.exports = {
    'sizes.html test - tests are actually ran on the page, nightwatch just confirms values' : function (browser) {
        browser
            .url('http://localhost:8081/demos/globalDemo/sizes.html')
            .waitForElementVisible('#test1', 1000)
            // .assert.containsText('#adjustableColumn_r0c3', '1')
            //.expect.element('#adjustableColumn_r0c3').to.have.value.that.equals('1')
            .assert.containsText("#test1", "1")
